show databases;
create database siulibmg;
use siulibmg;

desc - describe table - show description oor info about sstructure of table.
Base table and referencing

//creation of tables
create table tab_name(colm_name datatype constraints,colm_name datatype constraints,colm_name datatype constraints.......);

********* SIU LIBRARY database********

---------------------CREATE TABLES COMMAND-----------------------

create table siu_lib(slid int auto_increment primary key,
...
create table Ilib(lid int auto_increment primary key, 
lname varchar(20) not null, 
city varchar(20), 
area varchar(20), 
slid int, 
foreign key(slid) references siu_lib(slid));

create table books(bid int auto_increment primary key, 
bname varchar(30) not null, 
price float, 
lid int, 
foreign key(lid) references Ilib(lid));

create table noofcopies(bnid int auto_increment primary key, bid int, lid int,
foreign key(lid) references Ilib(lid),
foreign key(bid) references books(bid));

create table author(Aid int auto_increment primary key, 
aname varchar(10) not null, 
email varchar(30), 
phoneno int);

create table publisher(Pid int auto_increment primary key, 
pname varchar(15) not null);

create table writes(bid int, Aid int , Pid int, 
foreign key(bid) references books(bid), 
foreign key(Aid) references author(Aid), 
foreign key(Pid) references publisher(Pid));

create table seller(Sid int auto_increment primary key, 
slname varchar(20) not null, 
city varchar(10));

create table department(deptid int auto_increment primary key, 
deptname varchar(15), Iname varchar(20) not null, lid int, 
foreign key(lid) references Ilib(lid));

create table member(memid int auto_increment primary key,lid int, 
foreign key(lid) references Ilib(lid));

create table student(Stuid int auto_increment primary key, 
sname varchar(20) not null, email varchar(30) , memid int , 
foreign key(memid) references member(memid), deptid int, 
foreign key(deptid) references department(deptid));

create table staff(Stid int auto_increment primary key, 
stname varchar(20) not null, 
email varchar(30), deptid int, memid int, 
foreign key(memid) references member(memid), 
foreign key(deptid) references department(deptid));

create table purchase(prid int auto_increment primary key, 
lid int, Pid int, Sid int, bid int, 
quantity int, 
date date, 
totalcost float, 
foreign key(lid) references Ilib(lid), 
...
create table issue(issueid int auto_increment primary key, 
memid int, bid int, lid int,bnid int, issuedate date, 
returndate date, 
foreign key(memid) references member(memid),
foreign key(bid) references books(bid),
...
create table sells(Sid int, bid int, Pid int,
foreign key(bid) references books(bid),
foreign key(Sid) references seller(Sid),
foreign key(Pid) references publisher(Pid));

create table employee(eid int auto_increment primary key, 
empname varchar(20) not null, email varchar(30), 
salary float, lid int, foreign key(lid) references Ilib(lid));

create table A_specialization(spec_id int auto_increment primary key, 
spec_name varchar(20) not null, Aid int, 
foreign key(Aid) references author(Aid));
...
(5,3,2),(6,3,3), (7,2,1), (8,2,2),
(9,4,1),(10,4,2), (11,4,3), (12,5,1),
(13,5,2),(14,6,1),(15,7,1),(16,8,1),
(17,8,2),(18,9,1),(19,10,1),(20,11,1),
(21,12,1),(22,12,2),(23,13,1),(24,13,2),
(25,14,1),(26,14,2),(27,14,4),(28,15,1), (29,15,2),
(30,16,1),(31,16,2),(32,17,1);
...
values
(1,1,2),(2,2,3), (3,5,2),(4,6,4),
(5,1,5),(6,1,2),(7,4,1),(8,2,2),
(9,5,5),(10,6,4),(11,1,1),(12,4,2),
(13,5,5),(14,6,2),(15,3,1),(16,4,2),
(17,6,5),(18,2,4),(19,5,1),(20,1,2),
(21,3,5),(22,5,2),(23,6,1),(24,3,3);
...
values
(1001,1,1,3,1,100,'2015-07-12',70000),(1002,2,3,4,2,1000,'2015-04-10',80000),
(1003,1,4,2,5,45,'2016-08-01',4500),(1004,4,1,5,6,34,'2016-02-06',23000),
(1005,3,4,1,9,20,'2017-03-15',1200),(1006,1,2,4,10,89,'2017-04-20',4500),
(1007,2,5,2,12,67,'2018-07-25',5600),(1008,3,2,4,15,45,'2018-03-27',50000),
(1009,4,3,1,16,340,'2019-02-12',7800),(1010,1,1,2,17,23,'2020-07-11',10000);



insert into A_specialization(spec_id,Aid,spec_name)
values
(101,1,'Technical'),(201,1,'Fiction'),
(301,2,'Non_Fiction'),(401,3,'Autobiographies'),
(501,2,'Technical'),(601,4,'Real life stories');
